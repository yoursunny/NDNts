...
import { Component, Data, Decrypter, Name, Signer } from "@ndn/packet";
...
export class KeyDecryptionKey {
  ...
  public async loadKeyPair(decrypter: Decrypter, extractable = false): Promise<CryptoAlgorithm.GeneratedKeyPair> {
